...
export const updateState = (event) => {
  return event.output.split(/\r\n|\r|\n/g); // splitting at linebreak
};

export const render = (output) => {

  const os = output[0]; // OS-Version part
  const up = output[1]; // Up-Time part

  /* --- Create the up-time string --------------------------------------*/
  const upValues  = up.split(" ");
  ...
  switch (osVersion.substr(0,5)) {
    case '10.10': icon = iconDir + "yosemite.png";    osRelease = ' Yosemite';    break;
    case '10.11': icon = iconDir + "el_capitan.png";  osRelease = ' El Capitan';  break;
    case '10.12': icon = iconDir + "sierra.png";      osRelease = ' Sierra';      break;
    case '10.13': icon = iconDir + "high_sierra.png"; osRelease = ' High Sierra'; break;
    case '10.14':
      if (theme === 'dark' || theme === 'myDark') icon = iconDir + "mojave_dark.png";
      else icon = iconDir + "mojave.png";
      osRelease = ' Mojave';
      break;
    default: icon = iconDir + "mac_os.png";
  }
